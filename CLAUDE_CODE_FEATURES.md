...
| String evaluators (14) | Cheap auto-grading | ✅ exact_match, levenshtein, jaccard, regex, json_validity, contains_all/any, embedding_cosine, **`rouge_1` / `rouge_2` / `rouge_n` / `rouge_l`** (iter 304, NLG eval — n-gram + LCS-based F1 with clipped-overlap counts and case-folded whitespace tokenization) |
