...
| String evaluators (17) | Cheap auto-grading | ✅ exact_match, levenshtein, jaccard, regex, json_validity, contains_all/any, embedding_cosine, **`rouge_1` / `rouge_2` / `rouge_n` / `rouge_l`** (iter 304), **`bleu` / `bleu_n` / `bleu_smoothed`** (iter 305) |
