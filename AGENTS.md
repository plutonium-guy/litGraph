...
This project is indexed by GitNexus as **litGraph** (16980 symbols, 40856 relationships, 265 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
